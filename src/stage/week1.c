...
void Back_Week1_DrawBG(StageBack *back)
{
    ...
    plate_fill.x = FIXED_DEC(-160,1) - fx,
	plate_fill.y = FIXED_DEC(70,1) - fy,
	...
	static const struct Back_Week1_BackPiece
	{
		RECT src;
		fixed_t scale;
	} back_piece[] = {
	...
	back_fill.h = FIXED_DEC(140,1);
	Stage_DrawTex(&this->tex_back0, &back_src, &back_fill, stage.camera.bzoom);
	
	const struct Back_Week1_BackPiece *back_p = back_piece;
	...
	static const struct Back_Week1_CurtainPiece
	{
		RECT src;
		fixed_t scale;
	} curtain_piece[] = {
    ...
    curtain_fill.x = FIXED_DEC(-230,1) - fx,
	curtain_fill.y = FIXED_DEC(-185,1) - fy,
	...
	const struct Back_Week1_CurtainPiece *curtain_p = curtain_piece;
	...
	static const struct Back_Week1_StagePiece
	{
		RECT src;
		fixed_t scale;
	} stage_piece[] = {
	...
	stage_fill.y = FIXED_DEC(-180,1) - fy,
	...
	const struct Back_Week1_StagePiece *stage_p = stage_piece;
