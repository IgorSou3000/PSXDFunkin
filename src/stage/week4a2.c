...
//Week 4 A2 background structure
typedef struct
{
...
//Henchmen functions
void Week4a2_Henchmen_SetFrame(void *user, u8 frame)
{
	Back_Week4a2 *this = (Back_Week4a2*)user;
...
void Week4a2_Henchmen_Draw(Back_Week4a2 *this, fixed_t x, fixed_t y)
{
	//Draw character
...
//Week 4 A2 background functions
...
void Back_Week4a2_DrawBG(StageBack *back)
{
	Back_Week4a2 *this = (Back_Week4a2*)back;
	...
	Animatable_Animate(&this->hench_animatable, (void*)this, Week4a2_Henchmen_SetFrame);
	
	Week4a2_Henchmen_Draw(this, FIXED_DEC(-50,1) - fx, FIXED_DEC(30,1) - fy);
	Week4a2_Henchmen_Draw(this,  FIXED_DEC(50,1) - fx, FIXED_DEC(30,1) - fy);
	Week4a2_Henchmen_Draw(this, FIXED_DEC(150,1) - fx, FIXED_DEC(30,1) - fy);
	Week4a2_Henchmen_Draw(this, FIXED_DEC(250,1) - fx, FIXED_DEC(30,1) - fy);
...
void Back_Week4a2_Free(StageBack *back)
{
	Back_Week4a2 *this = (Back_Week4a2*)back;
...
StageBack *Back_Week4a2_New(void)
{
	//Allocate background structure
	Back_Week4a2 *this = (Back_Week4a2*)Mem_Alloc(sizeof(Back_Week4a2));
	if (this == NULL)
		return NULL;
	...
	this->back.draw_bg = Back_Week4a2_DrawBG;
	this->back.free = Back_Week4a2_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\WEEK4A2\\BACK.ARC;1");
	...
	this->arc_hench = IO_Read("\\WEEK4A2\\HENCH.ARC;1");
