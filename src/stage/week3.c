...
typedef struct
{
	...
	//Textures
    IO_Data arc_buddy, arc_buddy_ptr[3];
	IO_Data arc_buddy2, arc_buddy2_ptr[3];
...
static const CharFrame buddy_frame[] = {
	{0, {  0,   0,   96,  136}, { 46, 115}}, //0 left 1
	{0, { 96,   0,   96,  136}, { 43, 115}}, //1 left 2
	{1, {  0,   0,   96,  136}, { 48, 115}}, //2 left 3
	{1, { 96,   0,   96,  136}, { 45, 116}}, //3 left 4
	{2, {  0,   0,   96,  136}, { 48, 116}}, //4 left 5
...
static const CharFrame buddy2_frame[] = {
	{0, {  0,   0,  104,  117}, { 50, 119}}, //0 left 1
	{0, {104,   0,  104,  117}, { 50, 119}}, //1 left 2
	{1, {  0,   0,  104,  117}, { 50, 119}}, //2 left 3
	{1, {104,   0,  104,  117}, { 50, 119}}, //3 left 4
	{2, {  0,   0,  104,  117}, { 50, 119}}, //4 left 5
...
//Buddy functions
void Week3_Buddy_SetFrame(void *user, u8 frame)
{
...
void Week3_Buddy_Draw(Back_Week3 *this, fixed_t x, fixed_t y)
{
	//Draw character
...
//Buddy functions
void Week3_Buddy2_SetFrame(void *user, u8 frame)
{
	Back_Week3 *this = (Back_Week3*)user;
...
void Week3_Buddy2_Draw(Back_Week3 *this, fixed_t x, fixed_t y)
{
	//Draw character
...
void Back_Week3_DrawBG(StageBack *back)
{
	...
	Animatable_Animate(&this->buddy_animatable, (void*)this, Week3_Buddy_SetFrame);

	if (stage.stage_id == StageId_3_2)
	Week3_Buddy_Draw(this, FIXED_DEC(-114,1) - fx, FIXED_DEC(92,1) - fy);

	else
	Week3_Buddy_Draw(this, FIXED_DEC(-900,1) - fx, FIXED_DEC(60,1) - fy);
	...
	Animatable_Animate(&this->buddy2_animatable, (void*)this, Week3_Buddy2_SetFrame);

	if (stage.stage_id == StageId_3_2)
	Week3_Buddy2_Draw(this, FIXED_DEC(110,1) - fx, FIXED_DEC(112,1) - fy);

	else
	Week3_Buddy2_Draw(this, FIXED_DEC(-900,1) - fx, FIXED_DEC(80,1) - fy);
...
StageBack *Back_Week3_New(void)
{
	...
	//Load buddy textures
	this->arc_buddy = IO_Read("\\WEEK3\\BUDDY.ARC;1");
	...
	//Load buddy textures
	this->arc_buddy2 = IO_Read("\\WEEK3\\BUDDY2.ARC;1");
