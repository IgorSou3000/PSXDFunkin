...
void Speaker_Init(Speaker *this)
{
	...
	if (stage.stage_id == StageId_1_3 ||stage.stage_id == StageId_3_3 ||stage.stage_id == StageId_4_3 ||stage.stage_id == StageId_4_4)
	{
		Gfx_LoadTex(&this->tex, IO_Read("\\CHAR\\SPEAKER2.TIM;1"), GFX_LOADTEX_FREE);
	}
