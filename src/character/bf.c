...
enum
{
	...
	BF_ArcMain_Shoot0, //shoot left and down
	BF_ArcMain_Shoot1, //shoot up0
	BF_ArcMain_Shoot2, //shoot up1
	BF_ArcMain_Shoot3, //shoot right
...
static const CharFrame char_bf_frame[] = {
	{BF_ArcMain_Idle, {  0,   0, 116, 128}, { 50,  93}}, //0 idle 1
	{BF_ArcMain_Idle, {116,   0, 140, 126}, { 53,  93}}, //1 idle 2
	{BF_ArcMain_Idle, {  0, 126, 116, 128}, { 52,  93}}, //2 idle 3
	{BF_ArcMain_Idle, {116, 126, 140, 128}, { 55,  93}}, //3 idle 4
	
	{BF_ArcMain_Hit0,  {  0,   0, 122, 122}, { 42,  93}}, //4 left 1
	{BF_ArcMain_Hit0,  {122,   0, 122, 122}, { 46,  93}}, //5 left 2
	{BF_ArcMain_Miss0, {  0,   0, 122, 122}, { 42,  93}}, //6 left miss 1
	{BF_ArcMain_Miss0, {122,   0, 122, 122}, { 46,  93}}, //7 left miss 2
	
	{BF_ArcMain_Hit0,  {  0, 122, 122, 122}, { 39,  84}}, //8 down 1
	{BF_ArcMain_Hit0,  {122, 122, 122, 122}, { 43,  83}}, //9 down 2
	{BF_ArcMain_Miss0, {  0, 122, 122, 122}, { 37,  83}}, //10 down miss 1
	{BF_ArcMain_Miss0, {122, 122, 122, 122}, { 37,  83}}, //11 down miss 2
	
	{BF_ArcMain_Hit1,  {  0,   0, 122, 122}, { 34,  99}}, //12 up 1
	{BF_ArcMain_Hit1,  {122,   0, 122, 122}, { 34,  99}}, //13 up 2
	{BF_ArcMain_Miss1, {  0,   0, 122, 122}, { 34,  99}}, //14 up miss 1
	{BF_ArcMain_Miss1, {122,   0, 122, 122}, { 34,  99}}, //15 up miss 2
	
	{BF_ArcMain_Hit1,  {  0, 124, 114, 122}, { 43,  95}}, //16 right 1
	{BF_ArcMain_Hit1,  {114, 124, 124, 122}, { 44,  94}}, //17 right 2
	{BF_ArcMain_Miss1, {  0, 124, 114, 122}, { 42,  94}}, //18 right miss 1
	{BF_ArcMain_Miss1, {114, 124, 124, 122}, { 42,  94}}, //19 right miss 2
	
	{BF_ArcMain_Peace, {  0,   0, 122, 124}, { 41,  98}}, //20 peace 1
	{BF_ArcMain_Peace, {122,   0, 122, 124}, { 45,  98}}, //21 peace 2
	{BF_ArcMain_Peace, {  0, 124, 122, 124}, { 42,  97}}, //22 peace 3
	...
	{BF_ArcDead_Dead1, {  0,   0, 128, 127}, { 53,  98}}, //27 dead1 0
	{BF_ArcDead_Dead1, {128,   0, 128, 127}, { 53,  98}}, //28 dead1 1
	{BF_ArcDead_Dead1, {  0, 128, 128, 128}, { 58,  96}}, //29 dead1 2
	{BF_ArcDead_Dead1, {128, 128, 128, 128}, { 56,  96}}, //30 dead1 3
	
	{BF_ArcDead_Dead2, {  0,   0, 128, 128}, { 58,  98}}, //31 dead2 body twitch 0
	{BF_ArcDead_Dead2, {128,   0, 128, 128}, { 56,  98}}, //32 dead2 body twitch 1
	{BF_ArcDead_Dead2, {  0, 128, 128, 128}, { 58,  98}}, //33 dead2 balls twitch 0
	{BF_ArcDead_Dead2, {128, 128, 128, 128}, { 56, 100}}, //34 dead2 balls twitch 1

	{BF_ArcMain_Shoot0, {  0,  0, 125, 102}, { 42,  84}}, //18 right miss 1
	{BF_ArcMain_Shoot0, {125,  0, 124, 102}, { 42,  84}}, //19 right miss 2
	
	{BF_ArcMain_Shoot0, {  0, 128, 125, 118}, { 52, 100}}, //18 right miss 1
	{BF_ArcMain_Shoot0, {125, 128, 125, 118}, { 42, 100}}, //19 right miss 2

	{BF_ArcMain_Shoot1, {  0,  0, 136, 116}, { 42,  100}}, //18 right miss 1
	{BF_ArcMain_Shoot2, {  0,  0, 136, 116}, { 42,  100}}, //19 right miss 2

	{BF_ArcMain_Shoot3, {  0,  0, 128, 100}, { 42,  84}}, //18 right miss 1
	{BF_ArcMain_Shoot3, {128,  0, 128, 100}, { 42,  84}}, //19 right miss 2
};
